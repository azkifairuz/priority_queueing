...
Route::prefix('admin')->middleware(['web'])->group(function () {
    ...
    Route::prefix('master')->group(function () {
            Route::view('/product-list','luxury.master.product.index')->name('product-list');
            Route::view('/brand-list','luxury.master.brand.index')->name('brand-list');
            Route::view('/category-list','luxury.master.category.index')->name('category-list');
            Route::view('/role-list','luxury.master.role.index')->name('role-list');
