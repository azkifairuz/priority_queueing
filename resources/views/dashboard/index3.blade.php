...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div class="md:col-span-12 lg:col-span-6 2xl:col-span-12">
                        ...
                        <table class="table bordered-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>#8457723</td>
                                    <td>Balenciaga Track Sneakers</td>
                                    <td>2</td>
                                    <td>$1,900.00</td>
                                ...
                                <tr>
                                    ...
                                    <td>#7583920</td>
                                    <td>Louis Vuitton Silk Scarf</td>
                                    <td>3</td>
                                    <td>$1,050.00</td>
                                ...
                                <tr>
                                    ...
                                    <td>#6729381</td>
                                    <td>Dior J’adior Slingback Heels</td>
                                    <td>1</td>
                                    <td>$1,200.00</td>
