        ...
        <div class="col-span-12">
            <div class="card border-0 overflow-hidden">
                <div class="card-header">
                    <h6 class="card-title mb-0 text-lg">Role list</h6>
                </div>
                <div class="card-body">
                    <table id="selection-table" class="border border-neutral-200 dark:border-neutral-600 rounded-lg border-separate	">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">Superadmin</h6>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">Product</h6>
                                    </div>
                                </td>
