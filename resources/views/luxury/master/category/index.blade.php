        ...
        <div class="col-span-12">
            <div class="card border-0 overflow-hidden">
                <div class="card-header">
                    <h6 class="card-title mb-0 text-lg">Category list</h6>
                </div>
                <div class="card-body">
                    <table id="selection-table" class="border border-neutral-200 dark:border-neutral-600 rounded-lg border-separate	">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">Footwear</h6>
                                    </div>
                                </td>
                                <td>
                                    <img src="https://placehold.co/40x40" alt="Brand Image" class="w-10 h-10 object-cover ">
                                </td>
                                <td>25</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">Tops</h6>
                                    </div>
                                </td>
                                <td>
                                    <img src="https://placehold.co/40x40" alt="Brand Image" class="w-10 h-10 object-cover l">
                                </td>
                                <td>18</td>
                                <td>
                                    <a href="javascript:void(0)" class="w-8 h-8 bg-primary-50 dark:bg-primary-600/10 text-primary-600 dark:text-primary-400 rounded-full inline-flex items-center justify-center">
