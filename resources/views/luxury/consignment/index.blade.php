        ...
        <div class="col-span-12">
            <div class="card border-0 overflow-hidden">
                <div class="card-header">
                    <h6 class="card-title mb-0 text-lg">Product Consignment list</h6>
                </div>
                <div class="card-body">
                    <table id="selection-table" class="border border-neutral-200 dark:border-neutral-600 rounded-lg border-separate	">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">Denim Jacket</h6>
                                    </div>
                                </td>
                                <td>Outerwear</td>
                                <td>Levi's</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">Classic Hoodie</h6>
                                    </div>
                                </td>
                                <td>Tops</td>
                                <td>H&M</td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-check style-check flex items-center">
                                        <input class="form-check-input" type="checkbox">
                                        <label class="ms-2 form-check-label">03</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">Slim Fit Jeans</h6>
                                    </div>
                                </td>
                                <td>Bottoms</td>
                                <td>Zara</td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-check style-check flex items-center">
                                        <input class="form-check-input" type="checkbox">
                                        <label class="ms-2 form-check-label">04</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">White Sneakers</h6>
                                    </div>
                                </td>
                                <td>Footwear</td>
                                <td>Nike</td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-check style-check flex items-center">
                                        <input class="form-check-input" type="checkbox">
                                        <label class="ms-2 form-check-label">05</label>
                                    </div>
                                </td>
                                <td>
                                    <div class="flex items-center">
                                        <h6 class="text-base mb-0 font-medium grow">Graphic T-Shirt</h6>
                                    </div>
                                </td>
                                <td>Tops</td>
                                <td>Uniqlo</td>
